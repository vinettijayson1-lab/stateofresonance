      ...
      <div className="max-w-sm mx-auto text-center flex flex-col items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 text-xs font-sans tracking-wide leading-relaxed">
            Worn it? Felt it? Scan below and tell us.
          </p>
        </div>

        {/* QR Code — framed in gold */}
        <div className="relative p-4 border border-[var(--color-gold-muted)] bg-white shadow-[0_0_30px_rgba(212,175,55,0.12)]">
        ...
        <p className="text-[10px] text-gray-700 uppercase tracking-widest font-mono">Point your camera at the code</p>
      </div>
    </section>
  );
}
