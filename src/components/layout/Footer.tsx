...
export default function Footer() {
  return (
    <footer className="border-t border-[#1a1a1a] bg-[#0a0a0a]">
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12 py-16 flex flex-col items-center text-center gap-8">

        {/* Brand + tagline — centered stack */}
        <div className="flex flex-col items-center gap-2">
          <Link href="/" className="font-serif text-lg text-[#fafafa]">
            State of Resonance
          </Link>
          <span className="text-sm text-[#737373] tracking-wide">
            Premium Heavyweight Streetwear
          </span>
        </div>

        {/* Essential links — centered row, wraps on mobile */}
        ...
        {/* Copyright — centered, divider above */}
