...
<template>
  <div class="home-view">
    ...
    <section class="void-choice">
      ...
      <div class="hero-bg" style="position:absolute;inset:0;background:linear-gradient(to bottom, rgba(0,0,0,0.5) 0%, rgba(5,5,7,0.8) 60%, #050507 100%), url('/hero_banner.png') center/cover no-repeat; z-index:0;"></div>
