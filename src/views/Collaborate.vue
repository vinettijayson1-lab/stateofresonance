  ...
  <div class="collab-view">
    ...
    <div class="collab-hero">
      <div class="collab-hero-bg">
        <img src="/images/lookbook/lookbook-hero.jpg" alt="Collaborate with State of Resonance" class="collab-hero-img" width="1080" height="1350" fetchpriority="high" />
    ...
    <section class="collab-who">
      <div class="container collab-who-inner">
        ...
        <div class="collab-who-img-wrap">
          <img src="/images/upgraded/ps-edit-2.jpg" alt="State of Resonance Garment" class="collab-who-img" width="800" height="1067" loading="lazy" />
        </div>
      </div>
    </section>
