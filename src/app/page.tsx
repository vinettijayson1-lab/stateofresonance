    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="py-20 md:py-32 border-t border-[#141414]">
        <div className="w-full max-w-3xl mx-auto px-8 flex flex-col items-center text-center">
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-[#fafafa] mb-12 md:mb-16">
            Featured Pieces
          </h2>
        </div>
        {/* Grid breaks out of the text column so products have room to breathe */}
      ...
      <section id="reviews" className="py-20 md:py-24 border-t border-[#141414] bg-[#0c0c0c]">
        <div className="w-full max-w-3xl mx-auto px-8 flex flex-col items-center text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl text-[#fafafa] mb-10 md:mb-12">
            What People Say
          </h2>
        </div>
        <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {featuredTransmissions.length > 0 && (
        <section className="py-32 border-t border-[#141414]">
          <div className="w-full max-w-3xl mx-auto px-8 flex flex-col items-center text-center">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-[#fafafa] mb-16">
              Transmissions
            </h2>
          </div>
