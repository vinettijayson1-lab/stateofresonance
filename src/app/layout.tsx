  ...
  return (
    ...
    >
      <body className="min-h-screen flex flex-col antialiased">
        ...
        <VercelAnalytics />
        <SpeedInsights />
        {/* TrustIndex — Rich Snippets (adds star ratings to Google search results) */}
        <Script
          id="trustindex-richsnippet"
          src="https://cdn.trustindex.io/assets/js/richsnippet.js?4ac058435219g3d9"
          strategy="lazyOnload"
        />
      </body>
    </html>
