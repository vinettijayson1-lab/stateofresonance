  ...
  return (
    <html lang="en" className={`${inter.variable} ${playfair.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-background text-foreground bg-noise relative">
        ...
        <Script id="judge-me-config" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: `window.jdgm=window.jdgm||{};window.jdgm.SHOP_DOMAIN='state-of-resonance.myshopify.com';window.jdgm.PLATFORM='shopify';window.jdgm.PUBLIC_TOKEN='-V1Ltj5NCRp5rGiOoAB6tIZNG3s';` }} />
