    ...
    <div className="min-h-screen bg-black">
      <section className="relative w-full pt-56 md:pt-64 pb-32 flex flex-col items-center justify-center border-b border-[rgba(255,255,255,0.05)] overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl max-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-serif text-white mb-8 tracking-wide uppercase leading-tight">More Than Fabric.<br />A Declaration.</h1>
          <p className="text-gray-400 font-sans text-sm md:text-base tracking-widest uppercase max-w-2xl mx-auto leading-relaxed">State of Resonance was born from a simple belief: what you wear should mean something.</p>
        </div>
      </section>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-300 font-sans text-sm leading-relaxed tracking-wide">
              ...
              <div className="p-6 border border-[rgba(212,175,55,0.2)] bg-[rgba(212,175,55,0.02)] mt-8">
                <p className="text-[var(--color-gold-muted)] font-sans text-xs uppercase tracking-widest leading-relaxed">Because of this intensely hands-on process, <strong className="text-white">only 10 pieces of each design are ever made.</strong> Once those 10 units are claimed, I move on to entirely new prints.</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-32 px-6 border-t border-[rgba(255,255,255,0.05)] bg-[radial-gradient(ellipse_at_center,_rgba(212,175,55,0.03)_0%,_black_70%)] text-center">
        <p className="text-[var(--color-gold-muted)] font-serif italic text-2xl md:text-4xl max-w-3xl mx-auto leading-relaxed shadow-gold">&quot;Wear the frequency.<br />Become the resonance.&quot;</p>
      </section>
    </div>
  );
}
